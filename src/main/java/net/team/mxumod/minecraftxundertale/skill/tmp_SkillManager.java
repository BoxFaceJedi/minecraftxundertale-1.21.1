...
public class tmp_SkillManager {
    ...
    public static void reduceMana(int amount) {currentMana.setValue(Math.max(0, currentMana.getValue() - amount));};

    public tmp_SkillManager() {
        // Add all skills here
        ...
        currentMana.addChangeListener(tmp_SkillManager::ManaHandler);
    }
